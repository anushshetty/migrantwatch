...
<div id="gen_form">
	<form method='post'  name='frm_level1' action='savesighting.php'>
			...
			<tr>
				...
				<td style='width:400px;margin-left:-20px'>
						<input size="30" type=text id="other_name_<? echo $type; ?>" name="other_name" value="Name" style="" onkeyup="update_others_<? echo $type; ?>()">
				</td>
			</tr>
			<tr>
				<td colspan='2'><hr></td>
