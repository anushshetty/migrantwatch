...
<?
   ...
   $publickey = "6Le5BboSAAAAAPp8Q9bXZ3_WJ7Bfilob1Sxpv0w5";
?>
...
<script language="javascript" type="text/javascript">
   $(document).ready(function() { 
		...
		messages: { 
			...
			location: "<br>please enter a mailing address",
			city: "<br>please enter a city",
			dist: "<br>please enter a district",
			state: "<br>please enter a state",
			country: "<br>please enter a country",
			pin: "<br>please enter a pincode",
...
<form id="migwatch_register" name=frm_register action=userlogin.php method=POST>
	...
	<tr>
		...
		<td align=right>Post code (PIN code)</td>
         ...
         <tr>
                <td></td><td><? echo recaptcha_get_html($publickey); ?></td>
        </tr>
