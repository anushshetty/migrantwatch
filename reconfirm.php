<?php
	session_start(); 
	$page_title="MigrantWatch: Resend confirmation mail";
...
?>
		...
		<div class="container first_image">
		    <div id='tab-set'>   
             	      <ul class='tabs'>
                         <li><a href='#x' class='selected'>confirm</a></li>
                     </ul>
     </div>
		     <FORM name=frm_reset action=userlogin.php method=POST>
		     <table style="width:500px;margin-left:auto;margin-right:auto">
			
			<tr><td colspan="2"><b>Please enter your email address to receive the confirmation link</b></td></tr>
			...
			<?php
				if ($_GET['cmd']=="mailed"){
					print "<tr><td>";
					print "The confirmation link has been emailed to you. Please check your mail.";
			...
			<tr>
				<td colspan=2 style='text-align:center'>
					<input type=submit value="Send confirmation link" onclick="javascript:return validate_reset();" class=buttonstyle />
					&nbsp;<input type=button value="Cancel" onclick="javascript:window.location.href='login.php';" class=buttonstyle />
					<br><input type=hidden name="cmd" value="reconfirm" /><br>
				</td>
			</tr>
			<?php
				}
