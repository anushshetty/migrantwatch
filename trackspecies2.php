...
<div class="container" style="width:950px;height:166px; margin-top:-20px;">
...
<input id="search" type="search" style="border:none;" value="search">
<input type="submit" style="margin-right:8px;border:solid 1px #666;width:30px" value="go"></div>
</div>
...
margin-bottom:0px;
  ...
  <div class="container first_image" style="width:950px;">

   
   <div class=''  style="width:950px; margin-left:auto; margin-right:auto;padding-bottom:40px;">
               
		<div class='' style='width:950px;margin-top:-5px' id='tab-set'>
			...
			<div id='text2' style='width:920px;'>
                  	<p><? include("last_sighting.php"); ?></p>
			</div>

			<div id='text3' style='width:920px;'>
				<p><? include("general_sighting.php"); ?></p>
			</div>
