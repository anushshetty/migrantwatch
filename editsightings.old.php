...
if($get_loc!='All' || $get_loc!='') {
  ...
  if( $get_species) {
    ...
    while ($data = mysql_fetch_assoc($result1)) {
       ...
       $location_remove = "<tr><td> " . $data['location_name'] ." <a href='editsightings.php?species=". $get_species . "'>Remove</a></td></tr>";
    ...
    $species_remove = "<tr><td> " . $data['common_name'] ." <a href='editsightings.php?location=". $get_loc . "'>Remove</a></td></tr>";
...
.search-box {
width:200px;background:#fff; list-style:none; padding:10px;margin-right:8px; 
background-image:url('images/boxshadow.gif'); background-position:bottom left; 
background-repeat:no-repeat }

}
</style>
<div class="container first_image" style="width:950px;padding-bottom:20px">
...
<div class='column span-24 last' id='tab-set'>
   ...
   <li><a href='#text1' class='selected' style="">my species</a></li>
   <li><a href='#text2' style="">my locations</a></li>
 
   </ul>



   <div id='text1' style="width:950px">
<table class="search-box" style="width:200px;float:right;border:solid 1px;margin-top:-33px;">
...
<?php
	...
	$res = mysql_query($sql);
              ...
              echo "<tr><td style='border-top:solid 1px'>LOCATION</td></tr><tr><td><select id='location' name='location' style='width:150px;display:block' onChange='this.form.submit();'><option style='width:250px' value='All'>-- SELECT --</option>";
...
echo $location_remove;
	...
	$res = mysql_query($sql);
     ...
     echo "<tr><td style='border-top:solid 1px'>SPECIES</td></tr><tr><td><select style='width:200px' name='species' onChange='this.form.submit();'><option value='All'>-- SELECT --</option>";
       while ($data1 = mysql_fetch_assoc($res)) {
