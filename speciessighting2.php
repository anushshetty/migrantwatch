...
<table width="770" cellpadding=4 cellspacing=0>
	...
	<tr><td colspan=2>You have reported the following sightings for <b><?php print($specie_name) ?></b> so far:</td></tr>
			<tr><td colspan=2>
				<table id="table1" width=100% cellpadding=3 cellspacing=0 style="/*border-width:1px;border-style:solid;border-color:#dedede*/">
					...
					$sql.= "WHERE l1.user_id = '".$user_id."' AND s.species_id = $id AND l1.deleted = '0' ";
...
$sLinkBegin = "<a class=thickbox rel=gallery-plants href=\"viewsighting.php?id=".$row['id']."&TB_iframe=true&height=400&width=500\">";
