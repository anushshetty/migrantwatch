...
<body>
        <!--<div id="container">-->
			...
			<form name="chooseDateForm" id="chooseDateForm" action="log/logfile.php" method=POST >
                    <table width=10% align=left bgcolor="#ffffff" style=" border: 1px solid #C3D9FF;">
                           <tr>
		     ...
		     <tr><td>From:<input name="date1" id="date1" class="date-pick" /></td></tr>
       	             <tr><td>To:<input name="date2" id="date2" class="date-pick" /></td></tr>
                     <tr><td><input type=submit value=submit></td></tr>
                     </table>        
                     </form>
                   
                    <table width=50% align=left bgcolor="#ffffff" style="margin-left:20px; border: 1px solid #C3D9FF;">
                               <tr>
					 <td align="center" colspan="2" bgcolor="#C3D9FF" >
                                	     <b>Log Files</b>
                                	 </td>
			       ...
			       <tr><td><div style="width:700px; height:300px; overflow:auto;padding:20px">
		               <div id="htmlExampleTarget"></div></div></td></tr>
		    </table>
                     <table width=20% align=left bgcolor="#ffffff" style="margin-left:20px; border: 1px solid #C3D9FF;">
		     	     <tr>
                                <td align="center" colspan="2" bgcolor="#C3D9FF" >
                                <b>Help: Log File</b>
                                </td>
