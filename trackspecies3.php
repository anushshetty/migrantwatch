...
<? include("main_includes.php"); include("db.php"); include("functions.php"); ?>
...
margin-bottom:0px;
   ...
   <div style="width:950px; margin-left:auto; margin-right:auto;background-color:#d6c182;padding-bottom:40px;">
               
		<div style='width:950px;background-color:#d6c182;' id='tab-set'>
