<? session_start();
   ...
   if ( !($_GET['friend']) ) {
      echo "<div class='error1'>Invalid search.</div>";
      exit();
   }
$user_id = $_SESSION['userid'];
$friend= trim(addslashes($_GET['friend']));
include("db.php");
...
$sql = "SELECT l1.obs_start,l1.number,l1.notes,s.common_name, l1.user_id, l.location_name, l.city, st.state, l1.sighting_date, l1.species_id, l1.location_id, ";
                ...
                $sql.= " l1.user_friend like '%$friend%'";
...
<? } else {  
   ...
   echo "<div class='notice'>You have no previous sighting reported on behalf of <? echo $friend; ?></div>";
