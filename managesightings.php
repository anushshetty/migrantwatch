...
<div class="container first_image">
     <div class='container' style="width:950px;margin-top:-5px" id='tab-set'>
     	  <ul class='tabs' style="margin-left:20px;"> 
   	      <li><a href='#edit' class='selected'><span>my&nbsp;sightings</span></a></li>
   	  </ul>
   	  <div id='edit' class=''>
	  <table class="filter">
...
?>
       ...
       <tr>
             <td colspan="6" style="background-color:#fff; text-align:center"><div class="error1">You have not yet reported any sightings for the selected season.</div></td>
       </tr>
       <table>
<?php }	?>
...
$(function(){
	$('a.delbox').click(function() {
	id = $(this).parents('div.delbox').attr('id');
	id = id.replace(/delete-/, "");
        alert(id);
	el = $(this);
	$.post('deletesighting.php', { id: id, ajax: 'true' }, function() {
		$(el).parents('tr').fadeOut(2000, function() {
