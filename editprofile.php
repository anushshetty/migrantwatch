...
<script src="editprofile/settings.js" type="text/javascript"></script>
<script>

pic1 = new Image(16, 16); 
pic1.src = "editprofile/loader.gif";
$(document).ready(function(){
$("#username").change(function() { 
alert($("#username").val());
var usr = $("#username").val();
if(usr.length >= 3) {
   $("#status").html('<img src="editprofile/loader.gif" align="absmiddle">&nbsp;Checking availability...');
    $.ajax({  
    type: "POST",  
    url: "check.php",  
    data: "username="+ usr,  
    ...
    if(msg == 'OK'){ 
           ...
           $(this).html('&nbsp;<img src="editprofile/accepted.png" align="absmiddle"> <font color="Green"> Available </font>  ');
	   }  else  {  
