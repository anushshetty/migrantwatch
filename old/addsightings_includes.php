	...
	var iteration = lastRow - 1;
 	var newElement ="<tr>" + "<td width='150px'>"
		...
		+ "<td>"
			...
			+ "</select>"
		+ "</td>"
		+ "<td><textarea id='entry_notes_" + iteration + "'  class='entry_notes'  name='entry_notes[]' size='25' style='font-size:11px; width:180px'><? echo $notesHintText; ?></textarea></td>"
...
function mainForm() {
  ...
  $().ready(function() {
        ...
        $('.entry_notes').autogrow({maxHeight: 180,lineHeight: 16});
