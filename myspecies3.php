...
<?
	...
	$_SESSION['myspecies']['season'] = $season;
        $_SESSION['myspecies']['location'] = $get_location;
         $_SESSION['myspecies']['species'] = $get_species;
...
<table style="width:200px;float:right">
		...
		<tr><td><select name='season' style="margin-left:10px;" onChange='this.form.submit();'>
	...
	$res = mysql_query($sql);
              ...
              echo "<tr><td>Location</td></tr><tr><td><select name='get_location' style='width:200px;display:block' onChange='this.form.submit();'><option style='width:200px' value='All'>-- SELECT --</option><ul>";
     while ($data1 = mysql_fetch_assoc($res)) {
			echo "<li>$data1[location_name] , $data1[city] , $data1[district]</li>";
      }
      echo "</ul></td></tr>";
	...
	$res = mysql_query($sql);
     ...
     echo "<tr><td>Species</td></tr><tr><td><select name='get_species' onChange='this.form.submit();'><option value='All'>-- SELECT --</option>";
       while ($data1 = mysql_fetch_assoc($res)) {
		...
		$result = mysql_query($sql);
					...
					if($result) {
						...
						while($row = mysql_fetch_array($result)) {
							...
							$sLinkEnd = "</a>";
							print "<tr>";
$sLinkBegin = "<a class=thickbox rel=gallery-plants href=\"editlevel.php?id=".$row['id']."&TB_iframe=true&height=400&width=500\">link</a>";
							print "<td>".$j."</td>";
