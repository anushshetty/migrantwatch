...
<script type="text/javascript">
	...
	function createMarker(point, html_content, icon) {
                var html_text = "<div style='width:300px; max-height:500px;'>" + html_content + "</ul></div>";
