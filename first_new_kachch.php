			   ...
			   <script src="http://abeautifulsite.net/notebook_files/87/jquery.ui.draggable.js" type="text/javascript"></script>
			   	   
					<!-- Core files -->
					     <script src="http://abeautifulsite.net/notebook_files/87/jquery.alerts.js" type="text/javascript"></script>
		<link href="http://abeautifulsite.net/notebook_files/87/jquery.alerts.css" rel="stylesheet" type="text/css" media="screen" />
						...
						return false;
                          ...
                          if ($('#species_<? echo $type; ?>_' + i).val() != '' && $('#obdate_<? echo $type; ?>_' + i).val() != '') {
                               ...
                               if( (num == numberHintText ) || (num != '' )) {
                                 if ( isNaN(num))  {
                                        alert('Please enter numerals under \'Number\' for entry no. ' + i);
                              	  ...
                              	  if ( ( num != numberHintText || num != '' )  && acc == '' ) {
                                        alert('Please select the \'Accuracy of count\' for entries where \'Number\' has been entered for entry no. ' + i);
...
<div class='sidebar box' style='width:240px;float:right;margin-top:-30px;padding-left:10px;margin-right:-20px;background-color:#fff'>
	...
	<div id="other_name_box_<? echo $type; ?>" style="height:54px"><div id="other_name_update_<? echo $type; ?>"></div></div><hr>
   <table  id="locDetails_<? echo $type; ?>" style="height:215px;background-color:#fff;text-align:right;display:none;">
...
<input size="30" type=text id="other_name_<? echo $type; ?>" name="other_name" value="Name" style="" onKeyUp="update_others_<? echo $type; ?>();" onKeyDown="update_others_<? echo $type; ?>();">
			...
			<tr>
					<td><a href="#" style='font-size:15px;' class="jqModal">Add a new Location</a></td>
...
JS;
    ...
    <tr>
			<td><span><a href='#x' style='font-size:15px' onclick='appendNewInput_<? echo $type; ?>();'>Add another species</a></td>
	</tr>
	<tr>
