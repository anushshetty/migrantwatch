...
<div class="container top">
 ...
 <li><a href="#">species</a>
        <ul>
            ...
            <li><a href="guide.php">highlighted species</a></li>
            <li><a href="all_species.php">all species</a></li>
        </ul><li>|</li>
    </li>
	<li><a href="#">campaigns</a>
        <ul>
            <li><a href="pied_cuckoo_campaign.php">pied cuckoo</a></li>
	...
	<li><a href="#">data</a>
        <ul>
            ...
            <li><a href="latest_summaries.php">latest summaries</a></li>
            <li><a href="terms_of_use.php">terms of use</a></li>
        </ul><li>|</li>
    </li>
	<li><a href="=resources.php">resources</a>
        <ul>
            <li><a href="getting_started.pgp">getting started with indian birds</a></li>
