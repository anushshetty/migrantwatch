...
<script language="JavaScript" type="text/javascript">
	...
	function stateChanged() {
		...
		document.frm_level1.action = "trackspecies.php";
		document.frm_level1.submit();
	}
	...
	function setLocationData() {
		...
		document.forms[0].action = 'trackspecies.php';
...
<div style="font-family:sans-serif; font-size:small; color:#DC7575;">This form is for reporting sightings of Palaearctic migrants. For Pied Cuckoo sightings, <a href="trackcuckoo.php"><u>click here</u></a>.</div>
...
<?php
	...
	include('footer.php');
?><?php include ("MWanalyticsTracking.php"); ?>
